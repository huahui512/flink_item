...
public class TableStreamConsumerKafka {
    public static void main(String[] args) throws Exception {
        ...
        EnvironmentSettings setting = EnvironmentSettings.newInstance()
                ...
                .useBlinkPlanner()
                .build();
        StreamTableEnvironment tableEnv = StreamTableEnvironment.create(env,setting); Properties properties = new Properties();
        properties.setProperty("bootstrap.servers", "localhost:9092");
        properties.setProperty("group.id", "test8");
//        properties.setProperty("auto.offset.reset", "earliest");
        properties.setProperty("auto.offset.reset", "latest");
        FlinkKafkaConsumer<String> kafkaStream = new FlinkKafkaConsumer<>("DimensionTablejoin", new SimpleStringSchema(), properties);
